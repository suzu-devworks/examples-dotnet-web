...
public static class RequestLocalizationOptionsExtentions
{
    /// <summary>
    ...
    public static RequestLocalizationOptions AddCustomCultures(this RequestLocalizationOptions options, params string[] supportedCultures)
    {
