...
public static class SwaggerGenOptionsExtensions
{
    ...
    /// <returns></returns>
    public static SwaggerGenOptions AddDefaultOptions(this SwaggerGenOptions options)
    {
        options.EnableAnnotations();
        options.DocumentFilter<OrderTagsDocumentFilter>();

        options.OperationFilter<HiddenParameterOperationFilter>();
        options.OperationFilter<RequestHeaderParameterAppenderOperationFilter>();
        options.OperationFilter<ResponseHeaderAppenderOperationFilter>();
    ...
    /// <returns></returns>
    public static SwaggerGenOptions AddXmlComments(this SwaggerGenOptions options, string? xmlFilePath = default)
    {
    ...
    {
        options.OperationFilter<AntiforgeryTokenParameterAppenderFilter>(headerName);
