...
public class AntiforgeryTokenParameterAppenderFilter : IOperationFilter
{
    private readonly string _name;
    private readonly ParameterLocation _location;

    public AntiforgeryTokenParameterAppenderFilter(string name, ParameterLocation location = ParameterLocation.Header)
    {
        _name = name;
        _location = location;
    }
