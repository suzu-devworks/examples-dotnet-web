...
public class AntiforgeryTokenParameterAppendingFilter : IOperationFilter
{
    private readonly string _name;
    private readonly ParameterLocation _location;

    public AntiforgeryTokenParameterAppendingFilter(string name, ParameterLocation location = ParameterLocation.Header)
    {
        _name = name;
        _location = location;
    }
